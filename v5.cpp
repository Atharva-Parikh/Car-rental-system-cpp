...
class Login_user:public Login{
	public:
		...
		void book_suv();
		void book_luxury();
		void invoice_hatchback();
		void invoice_sedan();
		void invoice_suv();
		void invoice_luxary();
		void search_hatchback(int car_to_book);
		void search_suv(int car_to_book);
		void search_sedan(int car_to_book);
		void search_luxary(int car_to_book);
		//do work function
		void do_user_work();
		void unbook();
};
...
void Login_user::search_hatchback(int car_to_book)
{
...
void Login_user::search_sedan(int car_to_book)
{
    char found  = 'n';
    ifstream fin2("SEDAN.dat",ios::in);
	while(fin2.read((char*)&c,sizeof(c)))
...
void Login_user::search_suv(int car_to_book)
{
     char found  = 'n';
    ifstream fin3("SUV.dat",ios::in);
	while(fin3.read((char*)&c,sizeof(c)))
...
void Login_user::search_luxary(int car_to_book)
{
    char found  = 'n';
    ifstream fin4("LUXURY.dat",ios::in);
	while(fin4.read((char*)&c,sizeof(c)))
...
void Login_user::invoice_hatchback()
{
    int n,p,m,c,v,z;
    cout<<"Thank You for Booking!Please enter following info"<<endl;

        cout<<"Enter Time for which u want to get car on rent according to ur convinience"<<endl;
        cout<<"1.Hours \n2.Days"<<endl;
        cin>>c;
        switch(c)
        {
        case 1:
            cout<<"Enter number of hours for which u want to get car on rent"<<endl;
            cin>>n;
            p=n*200;
            v=170;
            z=1011;
            cout<<"Invoice Number-"<<z<<endl;
            z=z+1;
            this->search_hatchback(car_to_book);
            this->username;
            cout<<"Customer Name-          "<<username<<endl;

            cout<<"Number of Hours-         "<<n<<endl;
            cout<<"Total rent-         "<<p<<endl;
            cout<<"Penalty per day-      "<<v<<endl;

            break;
        case 2:
            cout<<"Enter number of days for which u want to get car on rent"<<endl;
           cin>>n;
            m=n*24;
            p=m*200;
            z=1011;
           ...
           /* cout<<"Enter number of days for which u want to get car on rent"<<endl;
            ...
            m=n*24;
            p=m*200;
            cout<<"Your bill for "<<m<<"days is "<<p<<" INR"<<endl;
            break; */

        }

}
void Login_user::invoice_sedan()
{
    int n,p,m,c,v,z;
    cout<<"Thank You for Booking!Please enter following info"<<endl;
...
void Login_user::invoice_luxary()
{
    int n,p,m,c,v,z;
    cout<<"Thank You for Booking!Please enter following info"<<endl;
        ...
        case 1:
           cout<<"Enter number of hours for which u want to get car on rent"<<endl;
            ...
            cout<<"Invoice Number-"<<z<<endl;
            z=z+1;
            this->search_luxary(car_to_book);
            this->username;
            cout<<"Customer Name-          "<<username<<endl;
...
void Login_user :: book_hatchback()
{
	...
	if(found=='n'){
        ...
        case 1:
            ...
            cin>>n;
            p=n*200;
            cout<<"Your bill for "<<n<<"hours is "<<p<<" INR"<<endl;
            break;
        case 2:
            cout<<"Enter number of days for which u want to get car on rent"<<endl;
            cin>>n;
